...
export function getJaxFromPath(jaxes:JaxNode[], path:any[]) : JaxNode {
...
export function getJaxIndex(node){
...
export function reprocessMathJax(html: string){
...
function findSelectedDoms(div: HTMLDivElement, ev:MouseEvent) : boolean{
